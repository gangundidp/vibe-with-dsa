class Solution:
    ...
    Roman numerals are usually written largest to smallest from left to right. But in six special cases, 
    subtraction is used instead of addition:
...
if __name__ == "__main__":
    sols = Solution()
    s = "LVIII"
    print("Output: ", sols.romanToInt(s))
    s = "MCMXCIV"
    print("Output: ", sols.romanToInt(s))