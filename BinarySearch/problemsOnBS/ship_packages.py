...
class Solution:
    ...
    The loaded weights must not exceed the maximum weight capacity of the ship. Find out the least-weight capacity so 
    that you can ship all the packages within 'd' days .
    ...
    def findMinimumWeight(self, list_of_weights: List[int], days: int) -> int:
        pass